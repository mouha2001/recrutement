...
<div class="p-4 sm:ml-64 mt-14">
       ...
       <div class="flex justify-center">
            <h1 class="text-2xl font-bold"> Enrigistrement du proces verbal </h1>
        </div>


        <div class="flex justify-center">
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg ">
                <form class="max-w-sm mx-auto" method="POST" action="{{ route('rapporteur') }}" enctype="multipart/form-data" >
                    @csrf
                            ...
                            <div class="mb-4">
                               <label for="procesverbal" class="block text-sm font-medium text-gray-700">Procés Verbal</label>
                               <input type="file" name="procesverbal" id="procesverbal" class="mt-1 block w-full" accept="application/pdf" required>
                            </div>
