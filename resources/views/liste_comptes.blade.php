...
<div class="flex flex-col items-center mt-8 mb-4">
    <a href="{{ route('ajoutdepartement') }}" class="w-full md:w-auto">
        <button type="submit" class="text-white bg-yellow-700 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-md dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:w-auto transition duration-300 ease-in-out">Ajouter un compte</button>
    </a>
