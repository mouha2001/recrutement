...
<body class="antialiased bg-gray-200 font-body">
    ...
    <button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="inline-flex items-center p-2 mt-2 text-sm text-gray-500 rounded-lg ms-3 sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        ...
        <svg class="z-40 w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-1 rounded-lg">
            <div class="flex justify-center py-6 rounded-xl">
                <div class="container">
                    <div class="header">
                        <h1>Tableau de Bord du Président de la Commission</h1>
                    </div>
                    <div class="content">
                        {{-- <div class="welcome-message">Bienvenue, {{ Auth::user()->nom }}!</div> --}}
                        <div class="role-description">
                            <p>En tant que Président de la Commission, vous avez les responsabilités suivantes :</p>
                            <ul>
                                <li>Gérer les dossiers de candidatures</li>
                                <li>Transmettre les dossiers pour évaluation</li>
                                <li>Superviser le processus de sélection</li>
                                <li>Coordonner avec les membres de la commission</li>
                            </ul>
                        </div>
