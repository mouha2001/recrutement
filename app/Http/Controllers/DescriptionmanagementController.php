...
class DescriptionmanagementController extends Controller
{
    public function create()
    {
        return view('departements.ajoutdescriptionmanagement');
    }
    public function store(Request $request): RedirectResponse
    {
        ...
        // Rediriger l'administrateur vers sa propre page
          return redirect()->route('ajoutdescriptionmanagement')->with('success', 'Description du profil enregistrée avec succès!');;
    }
