...
class DescriptionsanteController extends Controller
{
    public function create()
    {
        return view('departements.ajoutdescriptionsante');
    }
    public function store(Request $request): RedirectResponse
    {
        ...
        // Rediriger l'administrateur vers sa propre page
          return redirect()->route('ajoutdescriptionsante')->with('success', 'Description du profil enregistrée avec succès!');;
    }
