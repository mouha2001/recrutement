...
class DescriptionphysiqueController extends Controller
{
    public function create()
    {
        return view('departements.ajoutdescriptionphysique');
    }
    public function store(Request $request): RedirectResponse
    {
        ...
        // Rediriger l'administrateur vers sa propre page
          return redirect()->route('ajoutdescriptionphysique')->with('success', 'Description du profil enregistrée avec succès!');;
    }
