...
class DescriptionijController extends Controller
{
    public function create()
    {
        return view('departements.ajoutdescriptionij');
    }
    public function store(Request $request): RedirectResponse
    {
        ...
        // Rediriger l'administrateur vers sa propre page
          return redirect()->route('ajoutdescriptionij')->with('success', 'Description du profil enregistrée avec succès!');;
    }
