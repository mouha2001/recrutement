...
class DescriptionmathematiqueController extends Controller
{
    public function create()
    {
        return view('departements.ajoutdescriptionmathematique');
    }
    public function store(Request $request): RedirectResponse
    {
        ...
        // Rediriger l'administrateur vers sa propre page
          return redirect()->route('ajoutdescriptionmathematique')->with('success', 'Description du profil enregistrée avec succès!');;
    }
