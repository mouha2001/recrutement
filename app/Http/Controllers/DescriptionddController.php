...
class DescriptionddController extends Controller
{
    public function create()
    {
        return view('departements.ajoutdescriptiondd');
    }
    public function store(Request $request): RedirectResponse
    {
        ...
        // Rediriger l'administrateur vers sa propre page
          return redirect()->route('ajoutdescriptiondd')->with('success', 'Description du profil enregistrée avec succès!');;
    }
